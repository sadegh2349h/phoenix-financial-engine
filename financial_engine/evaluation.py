...
from .multifactor_backtest import multifactor_backtest
...
def shadow_evaluate(
    ...
    *,
    ...
    """Evaluate the PHOENIX regime-aware multifactor strategy on a held-out window."""
    ...
    warmup = min(100, available_extra)
